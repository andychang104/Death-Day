...
public class ShortcutsNewPastActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Uid.length() == 0){
            Intent homeIntent = new Intent(ShortcutsNewPastActivity.this, LogInActivity.class);
            startActivity(homeIntent);
            finish();
        }
        else{
            Intent homeIntent = new Intent(ShortcutsNewPastActivity.this, MainActivity.class);
            homeIntent.putExtra("uid", Uid);
            homeIntent.putExtra("type", "pastnew");
            startActivity(homeIntent);
            finish();
        }
    }
